    ...
    <div className="grid gap-3 md:grid-cols-3 pb-10">
      <div className="relative gallery-img-1 h-[500px]
       text-center overflow-hidden">
        ...
        flex justify-center items-center flex-col text-white px-8 py-8">
<img src={design} alt="" className="h-12" />
 <img src={strip} alt="" />
      ...
      <div className="relative gallery-img-1  h-[500px]
       text-center overflow-hidden">
        ...
        <div className="absolute bottom-0 w-full bg-gradient-to-t from-black/70 to-transparent gap-3 flex
         justify-center items-center flex-col text-white px-8 py-8">
<img src={silver} alt=""  className="h-10" />
      <img src={strip} alt="" />
      ...
      <div className="relative gallery-img-1  h-[500px]
       text-center overflow-hidden">
        ...
        <div className="absolute bottom-0 w-full bg-gradient-to-tnb gap-3
         from-black/70 to-transparent flex justify-center items-center flex-col text-white px-8 py-8">
<img src={set} alt=""  className="h-10" /> 
         <img src={strip} alt="" />
