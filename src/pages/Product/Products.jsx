...
const products = [
  { id: 1, name: "मंगळसूत्रे", category: "Discover the perfect blend of tradition acollection of Mangalsutras.", image: card1 },
    ...
    <div>
      ...
      <div className=' '>
        <div
          ...
          className="bg-cover flex justify-center items-center shadow-2xl bg-no-repeat bg-center min-h-[350px] w-full"
        >
