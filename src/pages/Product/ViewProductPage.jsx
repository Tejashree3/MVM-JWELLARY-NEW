...
//                                 alt="Product"
//                                 className="  min-h[610px] w-full max-w-[500px] object-cover rounded-lg"
//                             />
...
//                                     src={img}
//                                     alt="Thumbnail"
//                                     className={`w-20 h-25 object-cover cursor-pointer rounded-lg ${currentImage === index ? "border-2 p-1 border-gray-500" : ""
//                                         }`}
    ...
    return (
        <div>
            <div
                ...
                className="bg-cover flex justify-center shadow-2xl items-center bg-no-repeat bg-center min-h-[350px] w-full"
            >
                <div className='container '>
                    <div className='mb-6'>
                        <Link to={ROUTES.HOME}>
...
/>
                    ...
                    <div className=" w-full md:w-1/2 flex flex-col gap-2 md:pr-0 pr-0   ">
                        <h2 className="text-md font-medium pb-5 text-[#8F8F8F]">{product.title}</h2>
                       ...
                       <div className='py-3 flex gap-3 flex-col'>
                            ...
                            <h5 className='text-lg font-bold'>
                                Description</h5>
                            <p className="text-md font-medium text-[#8F8F8F]">{selectedProduct?.desc}</p>
                        </div>
                        <div className=' flex flex-col gap-3 pt-2'>
                            <h5 className='text-lg font-bold'>
                                Key feature</h5>
